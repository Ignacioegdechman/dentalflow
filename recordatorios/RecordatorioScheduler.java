...
public class RecordatorioScheduler {
    ...
    public void ejecutar() {
        ...
        turnoRepository.findByFechaHoraInicioBetween(desde, hasta).stream()
                ...
                .forEach(turno -> {
                    recordatorioService.enviarRecordatoriosCompleto(turno.getId());
                    recordatorioService.prepararWhatsApp(turno.getId());
                    recordatorioService.enviarWhatsAppOdontologo(turno.getId());
                });
    }
}
